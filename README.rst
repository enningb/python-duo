...
.. |commits-since| image:: https://img.shields.io/github/commits-since/enningb/python-duo/v0.1.2.svg
    :alt: Commits since latest release
    :target: https://github.com/enningb/python-duo/compare/v0.1.2...master
